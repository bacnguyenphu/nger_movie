function TippyMovieGenre({ movieGenre,onClickMovieGenre }) {
    ...
    return (
        <div className="rounded-md min-w-[400px]  bg-[#17161B] font-light text-gray-500 p-5 text-[14px] flex flex-wrap justify-between gap-y-3 animate-height-down duration-200 after:h-[3px] after:w-full after:absolute after:bg-blue-500 after:left-0 after:top-0 after:rounded-t-md lg:after:block after:hidden ">
